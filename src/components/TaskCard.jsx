...
const TaskCard = ({ task, fetchAllTasks }) => {
  const handleCompleteTask = async () => {
    try {
      await axios.patch(`https://sequelize-intro-starting-point-three.vercel.app/api/tasks/${task.id}`, {
  ...
  const handleDeleteTask = async () => {
    try {
      await axios.delete(`https://sequelize-intro-starting-point-three.vercel.app/api/tasks/${task.id}`);
      fetchAllTasks();
    } catch (error) {
